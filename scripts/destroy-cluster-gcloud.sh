...
gcloud dns record-sets transaction remove $VAMP_IP_ADDRESS --name="${NAME}.demo-ee.vamp.cloud" --ttl="300" --type="A" --zone="demo-vamp-cloud"
gcloud dns record-sets transaction remove $VGA_IP_ADDRESS --name="*.${NAME}.demo-ee.vamp.cloud" --ttl="300" --type="A" --zone="demo-vamp-cloud"
